...
- **Rate limits** (`s:` / `w:`) — 5-hour session and 7-day weekly usage percentages. The weekly value carries a `-d<N>` suffix for which day (1–7) of the current 7-day window you're on (e.g. `w:18%-d3`). When either crosses 90%, it turns yellow and appends the reset countdown (`resets in 2h15m`).
